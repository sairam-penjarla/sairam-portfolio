...
@app.route('/cheatsheets', defaults={'subsection': None, 'blog_slug': None})
@app.route('/cheatsheets/<subsection>', defaults={'blog_slug': None})
@app.route('/cheatsheets/<subsection>/<blog_slug>')
def cheatsheets(subsection, blog_slug):
    base_path = 'cheatsheets'
    print(subsection, blog_slug)
